		<div class="row" class="col s12 l10 offset-l1">	
        ...
        <!-- <div class="col s12 m6 l3" style="padding: 5px;">
				<div class="col s12 center-align">
					...
					<div class="chip" style="background-color:#ffff5d;">Charte graphique</div>
					<div class="chip" style="background-color:#6cffff;">Dessin vectoriel</div>
